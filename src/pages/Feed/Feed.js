...
class Feed extends Component {
  ...
  finishEditHandler = (postData) => {
    ...
    fetch("http://localhost:8080/handle-image", {
      method: "PUT",
      headers: {
        Authorization: "Bearer " + this.props.token,
      },
      ...
      .then((resData) => {
        ...
        const post = {
          _id: resData.data[query]._id,
          title: resData.data[query].title,
          content: resData.data[query].content,
          creator: resData.data[query].creator,
          createdAt: resData.data[query].createdAt,
          imagePath: resData.data[query].imageUrl,
        };
        this.setState((prevState) => {
  ...
  deletePostHandler = (postId) => {
    ...
    fetch("http://localhost:8080/graphql", {
      ...
      .then((resData) => {
        ...
        this.loadPosts();
        //baraye ghandle kardane pagination mige load va setState nemikone
      })
      .catch((err) => {
